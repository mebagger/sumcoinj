...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        ...
        assertEquals("mLTC 0.00", MonetaryFormat.MLTC.format(Coin.ZERO).toString());
        assertEquals("µLTC 0", MonetaryFormat.ULTC.format(Coin.ZERO).toString());
    }

    @Test
    public void standardSymbol() throws Exception {
        assertEquals(MonetaryFormat.SYMBOL_LTC + " 0.00", new MonetaryFormat(true).format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dLTC 0", MonetaryFormat.ULTC.code(1, "dLTC").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dLTC 0", MonetaryFormat.ULTC.noCode().code(1, "dLTC").shift(1).format(Coin.ZERO).toString());
    }
